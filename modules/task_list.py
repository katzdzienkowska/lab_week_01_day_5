...
def get_uncompleted_tasks(list):
    ...
    # new_list = [] #placeholder for our uncompleted tasks
    # for task in list:
    #     #if !task["completed"] -> for false, if task["completed"] -> if true  
    #     if task["completed"] == False: #checks which task is completed /uncompleted, if false, so smth with it
    #         new_list.append(task) #if false, add it to this list
